...
#wget -q -O /usr/bin/menu-bot "https://raw.githubusercontent.com/adammoi/xoc/main/update/menu-bot.sh" && chmod +x /usr/bin/menu-bot
...
#wget -q -O /usr/bin/menu-backup "https://raw.githubusercontent.com/adammoi/xoc/main/update/menu-backup.sh" && chmod +x /usr/bin/menu-backup
#wget -q -O /usr/bin/menu-ip "https://raw.githubusercontent.com/adammoi/xoc/main/update/menu-ip.sh" && chmod +x /usr/bin/menu-ip
#wget -q -O /usr/bin/menu-tor "https://raw.githubusercontent.com/adammoi/xoc/main/update/menu-tor.sh" && chmod +x /usr/bin/menu-tor
